...
export default {
  ...
  plugins: {
    ...
    batchDeleteConfirm: 'Excluir os {count} plugins selecionados? Os diretórios de código serão removidos, mas as configurações de pacote e os dados do usuário serão mantidos.',
    ...
    dangerDialog: {
      ...
      deleteMessage: 'Excluir "{pluginName}" removerá o diretório de código do plugin. As configurações de pacote e os dados do usuário serão mantidos. A lista será atualizada imediatamente.',
    ...
    retainedData: {
      entry: 'Dados mantidos',
      title: 'Dados mantidos após a desinstalação',
      description: 'Gerencie os dados de configuração do pacote mantidos após a remoção do código do plugin.',
      scopeNotice: 'Isto exclui apenas diretórios de configuração criados e pertencentes explicitamente ao pacote. Outros estados de plugins e arquivos arbitrários do usuário não são removidos.',
      empty: 'Não há dados mantidos para gerenciar',
      packageId: 'Pacote',
      candidate: 'Candidato anterior',
      codePresent: 'O código do candidato ainda existe. Primeiro desinstale o plugin normalmente.',
      deleteAction: 'Excluir dados mantidos',
      confirmTitle: 'Confirmar exclusão dos dados',
      confirmMessage: 'Isto exclui permanentemente os dados de configuração criados pelo pacote do plugin "{pluginId}". O código do plugin não será alterado.',
      confirmHint: 'A propriedade, o compartilhamento e a segurança do caminho são verificados novamente antes da exclusão. Mantenha o botão abaixo pressionado para evitar remoção acidental.',
      warningTitle: 'Estes dados não podem ser recuperados',
      holdIdle: 'Mantenha pressionado para excluir',
      holdActive: 'Continue pressionando para confirmar…',
      deleting: 'Excluindo dados mantidos…',
      loadFailed: 'Falha ao carregar dados mantidos',
      deleteSuccess: 'Dados mantidos excluídos',
      deleteFailed: 'Falha ao excluir dados mantidos',
    },
    ui: {
      open: 'Abrir UI',
      title: 'UI',
  ...
  logs: {
    ...
    clear: 'Limpar logs',
    clearTitle: 'Limpar logs do plugin',
    clearConfirm: 'Isso limpa permanentemente todos os logs salvos deste plugin. Novos logs podem continuar aparecendo enquanto ele estiver em execução.',
    clearSuccess: 'Logs do plugin limpos',
    clearFailed: 'Falha ao limpar os logs do plugin'
  },
  runs: {
    title: 'Execuções',
