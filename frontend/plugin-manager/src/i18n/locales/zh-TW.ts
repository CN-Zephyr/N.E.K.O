...
export default {
  ...
  market: {
    ...
    install: '安裝',
    installed: '已安裝',
    marketVersion: '市集 v{version}',
    marketInstalledVersion: '市集版 v{version}',
    localInstalledVersion: '本機 v{version} · {source}',
    useMarketVersion: '改用市集版',
    localVersionNewer: '本機版本較新',
    installing: '安裝中...',
    installSuccess: '安裝工作已建立: {name}',
    installFailed: '安裝失敗',
    installPreparing: '正在準備安裝...',
    installAlreadyRunning: '已有安裝任務正在進行，請等待其完成',
    externalInstallConfirmationTitle: '確認市集安裝',
    externalInstallConfirmationBody: '外掛市集要求對 {id} v{version} 執行 {mode}。頻道：{channel}；下載網域：{host}；SHA256：{sha256}。這些資料由發起要求的網頁提供，N.E.K.O 會在變更外掛檔案前再次驗證下載包。是否繼續？',
    cancelInstall: '取消安裝',
  ...
  plugins: {
    ...
    runtimeVersion: {
      title: '執行版本',
      description: '這個外掛有多份程式碼可用，你可以選擇實際執行哪一份。',
      current: '目前使用',
      useThisVersion: '使用這一版',
      builtinHint: '隨 N.E.K.O 提供的內建程式碼',
      marketHint: '從外掛市場安裝的程式碼',
      importedHint: '從本機安裝包匯入的程式碼',
      localHint: '本機或舊版外掛程式碼',
      sharedDataHint: '切換只會改變執行程式碼；設定、資料與快取仍由同一外掛 ID 共用。',
      confirmTitle: '切換執行版本',
      confirmBody: '將改用{source} v{version}。執行中的外掛會先停止，再使用新選擇重新啟動；使用者資料不會被刪除。',
      confirmDowngradeBody: '這會從 v{currentVersion} 切換到較舊的{source} v{version}。舊程式碼可能無法讀取較新的使用者資料，確定仍要切換嗎？',
      confirmAction: '確認切換',
      switchSucceeded: '已切換外掛執行版本',
      switchFailed: '切換失敗，已盡量恢復原本的執行版本',
      unavailable: '暫時無法切換執行版本',
      unavailableHint: '外掛來源記錄不完整或存在衝突，請重新整理後再試。',
      blockedReason: '無法選擇：{reason}',
    },
    ...
    batchDeleteConfirm: '確認移除或隱藏 {count} 個外掛？使用者安裝的程式碼會被刪除，內建程式碼仍會保留，外掛資料不會清除。',
    ...
    importSuccessRestartRequired: '已匯入 {name}。請重新啟動 N.E.K.O，將執行中的外掛切換至新安裝的版本。',
    importFailed: '匯入失敗',
    export: '匯出',
    ...
    dangerDialog: {
      title: '危險操作確認',
      warningTitle: '不可逆操作',
      deleteMessage: '刪除外掛「{pluginName}」後，它會從應用程式中移除；設定與資料將保留，方便日後重新安裝。',
  ...
  package: {
    install: {
      ...
      upgradeUnmanagedBody: '這個目錄不是由外掛中心管理的安裝，裡面可能有開發者手動修改。繼續會用 {target} 替換 {current}，覆蓋程式碼、相依套件和套件資源；確認後只要任一檔案改變，安裝就會停止。',
      upgradeConfirm: '升級外掛',
      upgradeCancelled: '已取消升級。',
      upgradeSucceeded: '{plugin} 已成功升級。',
      restartRequired: '安裝完成。重新啟動 N.E.K.O 後將使用新版本。',
      activationBlocked: '外掛程式未安全啟用，因此本次不算安裝成功。原因：{reason}',
      ...
      error: {
        ...
        manifestInvalid: '安裝套件的 manifest.toml 格式錯誤，請聯絡外掛作者修正後重新打包。',
        ...
        packageTypeMismatch: '套件宣告的類型與其中的外掛數量不一致，請聯絡作者重新打包。',
        hashMismatch: '套件內容與驗證資訊不一致，已拒絕安裝，未保留任何安裝變更。',
        hashMismatchRolledBack: '套件內容與驗證資訊不一致，已拒絕此次匯入並回復安裝前狀態。',
        packageStateConflict: '你修改過的外掛資料與新版本衝突。目前外掛已還原；請先備份修改過的檔案，再重試。',
