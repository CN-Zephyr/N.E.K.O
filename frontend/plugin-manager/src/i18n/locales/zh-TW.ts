...
export default {
  ...
  plugins: {
    ...
    batchDeleteConfirm: '確認批次刪除 {count} 個外掛？外掛程式碼目錄會被移除，關聯設定與使用者資料會保留。',
    ...
    dangerDialog: {
      title: '危險操作確認',
      warningTitle: '不可逆操作',
      deleteMessage: '刪除外掛「{pluginName}」後，其程式碼目錄會被移除，關聯設定與使用者資料會保留。列表會立即更新。',
    ...
    retainedData: {
      entry: '保留資料',
      title: '解除安裝後保留的資料',
      description: '管理外掛程式碼刪除後仍保留的安裝包設定資料。',
      scopeNotice: '這裡只刪除安裝包明確建立且仍由其擁有的設定目錄，不會清除其他外掛狀態或任意使用者檔案。',
      empty: '沒有可管理的保留資料',
      packageId: '資料包',
      candidate: '原候選',
      codePresent: '候選程式碼仍然存在，請先完成一般外掛解除安裝。',
      deleteAction: '刪除保留資料',
      confirmTitle: '確認刪除保留資料',
      confirmMessage: '將永久刪除外掛「{pluginId}」由安裝包建立的設定資料。外掛程式碼不會因此改變。',
      confirmHint: '刪除前會再次檢查資料歸屬、共用情況和路徑安全。為避免誤觸，請按住下方按鈕。',
      warningTitle: '此資料刪除後無法復原',
      holdIdle: '按住以刪除保留資料',
      holdActive: '繼續按住，正在確認…',
      deleting: '正在刪除保留資料…',
      loadFailed: '載入保留資料失敗',
      deleteSuccess: '保留資料已刪除',
      deleteFailed: '刪除保留資料失敗',
    },
    ui: {
      open: '開啟介面',
      title: '介面',
  ...
  logs: {
    ...
    clear: '清除日誌',
    clearTitle: '清除外掛日誌',
    clearConfirm: '這會永久清除該外掛所有已儲存的日誌。外掛運行期間仍可能持續產生新的日誌。',
    clearSuccess: '外掛日誌已清除',
    clearFailed: '清除外掛日誌失敗'
  },
  runs: {
    title: '執行記錄',
    detail: '執行詳情',
