...
export default {
  ...
  plugins: {
    ...
    batchDeleteConfirm: '選択した {count} 個のプラグインを削除しますか？プラグインのコードディレクトリは削除されますが、関連するパッケージ設定とユーザーデータは保持されます。',
    ...
    dangerDialog: {
      ...
      deleteMessage: '「{pluginName}」を削除すると、プラグインのコードディレクトリが消去されます。関連するパッケージ設定とユーザーデータは保持されます。一覧がすぐに更新されます。',
    ...
    retainedData: {
      entry: '保持データ',
      title: 'アンインストール後の保持データ',
      description: 'プラグインコード削除後も保持されるパッケージ設定データを管理します。',
      scopeNotice: 'パッケージが明示的に作成して所有する設定ディレクトリのみを削除します。他のプラグイン状態や任意のユーザーファイルは削除しません。',
      empty: '管理できる保持データはありません',
      packageId: 'パッケージ',
      candidate: '以前の候補',
      codePresent: '候補コードが残っています。先に通常のアンインストールを完了してください。',
      deleteAction: '保持データを削除',
      confirmTitle: '保持データの削除確認',
      confirmMessage: 'プラグイン「{pluginId}」について、パッケージが作成した設定データを完全に削除します。プラグインコードは変更されません。',
      confirmHint: '削除前に所有権、共有状態、パスの安全性を再確認します。誤操作防止のため下のボタンを長押ししてください。',
      warningTitle: 'このデータは復元できません',
      holdIdle: '長押しして保持データを削除',
      holdActive: 'そのまま長押ししてください…',
      deleting: '保持データを削除しています…',
      loadFailed: '保持データを読み込めませんでした',
      deleteSuccess: '保持データを削除しました',
      deleteFailed: '保持データを削除できませんでした',
    },
    ui: {
      open: 'UIを開く',
      title: 'UI',
  ...
  logs: {
    ...
    clear: 'ログを消去',
    clearTitle: 'プラグインログを消去',
    clearConfirm: 'このプラグインの保存済みログをすべて完全に消去します。実行中の場合は新しいログが引き続き出力されることがあります。',
    clearSuccess: 'プラグインログを消去しました',
    clearFailed: 'プラグインログを消去できませんでした'
  },
  runs: {
    title: '実行履歴',
    detail: '実行詳細',
