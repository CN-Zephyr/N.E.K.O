...
export default {
  ...
  plugins: {
    ...
    candidates: {
      ...
      hint: 'Solo se ejecuta una versión a la vez. Al cambiar, el plugin se reinicia de forma segura.',
      running: 'En ejecución',
      current: 'Seleccionada',
      invalid: 'No disponible',
      switch: 'Usar esta versión',
      none: 'No se encontraron versiones instaladas',
      loadFailed: 'No se pudieron cargar las versiones instaladas',
      switchSuccess: 'Se cambió la versión del plugin',
      switchFailed: 'No se pudo cambiar; se conservó la versión anterior',
      dataAccessRequired: 'Acceso a datos existentes',
      dataAccessTitle: '¿Permitir acceso a los datos existentes del plugin?',
      dataAccessPrompt: 'Esta versión de origen {source} podrá leer y modificar la configuración, los datos, la caché y las credenciales guardadas del plugin.',
      dataAccessConfirm: 'Permitir y cambiar',
    },
    installSource: {
      channel: {
        builtin: 'Integrado',
    ...
    batchDeleteConfirm: '¿Eliminar los {count} plugins seleccionados? Se borrarán los directorios de código, pero se conservarán la configuración del paquete y los datos del usuario.',
    ...
    dangerDialog: {
      ...
      deleteMessage: 'Al eliminar "{pluginName}" se borrará el directorio de código del plugin. Se conservarán la configuración del paquete y los datos del usuario. La lista se actualizará inmediatamente.',
    ...
    retainedData: {
      entry: 'Datos conservados',
      title: 'Datos conservados tras desinstalar',
      description: 'Gestiona los datos de configuración del paquete conservados después de eliminar el código del plugin.',
      scopeNotice: 'Solo se eliminan directorios de configuración creados y poseídos explícitamente por el paquete. No se borran otros estados de plugins ni archivos arbitrarios del usuario.',
      empty: 'No hay datos conservados que gestionar',
      packageId: 'Paquete',
      candidate: 'Candidato anterior',
      codePresent: 'El código del candidato todavía existe. Primero desinstala el plugin normalmente.',
      deleteAction: 'Eliminar datos conservados',
      confirmTitle: 'Confirmar eliminación de datos',
      confirmMessage: 'Esto elimina permanentemente los datos de configuración creados por el paquete del plugin "{pluginId}". El código del plugin no cambiará.',
      confirmHint: 'La propiedad, el uso compartido y la seguridad de la ruta se comprueban de nuevo antes de eliminar. Mantén pulsado el botón inferior para evitar borrados accidentales.',
      warningTitle: 'Estos datos no se pueden recuperar',
      holdIdle: 'Mantén pulsado para eliminar',
      holdActive: 'Sigue pulsando para confirmar…',
      deleting: 'Eliminando datos conservados…',
      loadFailed: 'No se pudieron cargar los datos conservados',
      deleteSuccess: 'Datos conservados eliminados',
      deleteFailed: 'No se pudieron eliminar los datos conservados',
    },
    ui: {
      open: 'Abrir UI',
      title: 'UI',
  ...
  logs: {
    ...
    clearTitle: 'Borrar registros del complemento',
    clearConfirm: 'Esto borra permanentemente todos los registros guardados de este complemento. Pueden seguir apareciendo registros nuevos mientras esté en ejecución.',
    clearSuccess: 'Registros del complemento borrados',
    clearFailed: 'No se pudieron borrar los registros del complemento'
  },
  runs: {
    title: 'Ejecuciones',
