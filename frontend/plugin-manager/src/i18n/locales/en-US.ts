...
export default {
  ...
  plugins: {
    ...
    batchDeleteConfirm: 'Delete {count} selected plugins? Their plugin code directories will be removed, while related package configuration and user data will be kept.',
    ...
    dangerDialog: {
      ...
      deleteMessage: 'Deleting "{pluginName}" will remove its plugin code directory. Related package configuration and user data will be kept. The list will refresh immediately.',
    ...
    retainedData: {
      entry: 'Retained Data',
      title: 'Data Retained After Uninstall',
      description: 'Manage package configuration data kept after plugin code is removed.',
      scopeNotice: 'This only deletes configuration directories explicitly created and owned by a package. Other plugin state and arbitrary user files are not removed.',
      empty: 'There is no retained data to manage',
      packageId: 'Package',
      candidate: 'Former candidate',
      codePresent: 'Candidate code is still present. Uninstall the plugin normally first.',
      deleteAction: 'Delete Retained Data',
      confirmTitle: 'Confirm Retained Data Deletion',
      confirmMessage: 'This permanently deletes package-created configuration data for plugin "{pluginId}". Plugin code will not be changed.',
      confirmHint: 'Ownership, sharing, and path safety are checked again before deletion. Press and hold below to prevent accidental removal.',
      warningTitle: 'This data cannot be recovered',
      holdIdle: 'Hold to delete retained data',
      holdActive: 'Keep holding to confirm…',
      deleting: 'Deleting retained data…',
      loadFailed: 'Failed to load retained data',
      deleteSuccess: 'Retained data deleted',
      deleteFailed: 'Failed to delete retained data',
    },
    ui: {
      open: 'Open UI',
      title: 'UI',
  ...
  logs: {
    ...
    clearConfirm: 'This permanently clears all saved logs for this plugin. New logs may continue to appear while the plugin is running.',
    clearSuccess: 'Plugin logs cleared',
    clearFailed: 'Failed to clear plugin logs'
  },
  runs: {
    title: 'Runs',
    detail: 'Run Detail',
